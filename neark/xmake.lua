...
target("neark-amd64")
    ...
    add_cflags("-target x86_64-pc-none-elf", "-ffreestanding", "-nostdlib", "-fno-exceptions", "-fno-rtti", "-fPIC", "-mcmodel=kernel", {force = true})
    add_cxxflags("-target x86_64-pc-none-elf", "-ffreestanding", "-nostdlib", "-fno-exceptions", "-fPIC", "-fno-rtti", "-mcmodel=kernel", {force = true})
    --add_asflags("-f elf64")
