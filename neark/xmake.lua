...
target("neark-amd64")
    ...
    add_asflags("-f elf64")
    add_ldflags("/machine:amd64 /subsystem:native /entry:hal_loader_entry /base:0x200000", {force = true})
...
target("neark-aarch64")
    ...
    add_ldflags("/machine:arm64 /subsystem:native /entry:hal_loader_entry /base:0x40100000", {force = true})
