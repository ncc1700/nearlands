...
void* ini_malloc(size_t size){
    void* alloc = NULL;
    qol_return_systab()->BootServices->AllocatePool(EfiLoaderData, size,(void**)&alloc);
    return alloc;
}

void ini_free(void* ptr){
    qol_return_systab()->BootServices->FreePool(ptr);
}

void* ini_realloc(void* ptr, size_t size){
    void* new = ini_malloc(size);
    qol_return_systab()->BootServices->CopyMem(new, ptr, size);
    return new;
}
